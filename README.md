...
| ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [Rock Paper Scissors Lizard Spock](https://github.com/mhbae-dev/rock-paper-scissors-lizard-spock)                                                   | This is a expansion on the classic game of Rock, Paper, Scissors. A tribute to the creators Sam Kass and Karen Bryla and The Big Bang Theory.                                                                                                                                                                                                | JavaScript, React, Express, CSS, Vercel                                  |
